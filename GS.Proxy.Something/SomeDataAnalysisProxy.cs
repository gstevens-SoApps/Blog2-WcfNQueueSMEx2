/*
GS.Proxy.Something.SomeDataAnalysisClient
...
namespace GS.Proxy.Something
{
    public class SomeDataAnalysisClient : ClientBase<ISomeServiceContract>, ISomeServiceContract
    {
        public SomeDataAnalysisClient(string endpointName)
            : base(endpointName)
        { }
