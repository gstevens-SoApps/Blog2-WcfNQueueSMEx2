...
namespace GS.Engine.Common
{
    ...
    {
        [OperationContract]
        InProcessFeedMsg IsTestMessageValid(TestMessage msg, DateTime receivedDateTime);

        // In a production app there would me more feed validity checks.  Perhaps one for
